...
int main(){
    ...
    char estado_1[2], estado_2[2], cidade_1[50], cidade_2[50];
    int codigo_1, codigo_2, pontos_turisticos_1, pontos_turisticos_2;
    float area_1, area_2, pib_1, pib_2, populacao_1, populacao_2;
    ...
    float pib_per_capita_1 = 1.00;

    printf("VALOR: %f", pib_per_capita_1);
    ...
    float pib_per_capita_2 = 1.00;

    printf("VALOR: %f", pib_per_capita_2);
